...
var loadData = function(dataResponse){
        var author = dataResponse[0].title,
            message = dataResponse[0].content;
    ...
    $("#tweet").attr("href", "https://twitter.com/intent/tweet?text=" + encodeURIComponent('"' + tweet + '" - ' + author) + "&hashtags=quotes");
    }
...
var ajaxData = function () {
        $.ajax({
            ...
            async:false,
            url: "http://quotesondesign.com/wp-json/posts?filter[orderby]=rand&filter[posts_per_page]=1&_jsonp=loadData",
            data: {projectID:1},
            dataType: "jsonp"                
        });
    }
...
$("document").ready(function () {
    // Get data from Quotes on Design API 4.0
    ajaxData();
